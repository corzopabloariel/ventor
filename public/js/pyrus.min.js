...
Pyrus = function( e = null, dataPYRUS = null , urlFile = null) {
    ...
    this.inputString = function(OBJ_elemento,STR_nombre,STR_type,STR_class,OBJ_funcion = null, placeholder = "", multiple = null) {
        ...
        input = `<input value="${OBJ_elemento.DEFAULT !== undefined ? OBJ_elemento.DEFAULT : ''}" ${(OBJ_elemento["DISABLED"] ? "disabled='true'" : "")} ${OBJ_elemento.READONLY === undefined ? '' : 'readonly'} ${inputData} name="${name}" id="${STR_id}" class="${STR_class}" type="${STR_type}" placeholder="${placeholder == "" ? OBJ_elemento["NOMBRE"] : placeholder}" />`;
    ...
    this.inputText = function(OBJ_elemento,STR_nombre,STR_class,OBJ_funcion = null, placeholder = "", multiple = null) {
        ...
        textarea = `<textarea ${(necesario ? "required='true'" : "")} ${(OBJ_elemento["DISABLED"] ? "disabled='true'" : "")} ${STR_funcion} name="${name}" id="${STR_id}" class="${STR_class}" placeholder="${placeholder == "" ? OBJ_elemento.NOMBRE : placeholder}"></textarea>`;
        if(OBJ_elemento.FIELDSET !== undefined)
    ...
    this.select = function(OBJ_elemento,STR_nombre,STR_class,OBJ_funcion,OBJ_datos = null,placeholder = null, multiple = null) {
        ...
        let return_STR = `<select ${(OBJ_elemento["MULTIPLE"] ? "multiple='true'" : "data-allow-clear='true'")} ${(OBJ_elemento.DISABLED ? "disabled='true'" : "")} ${(OBJ_elemento["NECESARIO"] ? "required='true'" : "")} ${STR_funcion} name="${name}" id="${STR_id}" class="${STR_class} select__2 w-100" data-tags="true" data-placeholder="${OBJ_elemento["NOMBRE"]}">`;
